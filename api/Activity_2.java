...
public class Activity_2 {
    ...
    public void addNewUserFromFile() throws IOException {
        // Import JSON file
        FileInputStream inputJSON = new FileInputStream("src/test/java/RA_Activities/userinfo.json");
    ...
    public void getUserInfo() {
        ...
        File outputJSON = new File("src/test/java/RA_activities/userGETResponse.json");
